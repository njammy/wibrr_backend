...
exports.productController.post("/izi", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            getIziwayProduct(req.body.findterm).then(function (dataScrap) {
...
exports.productController.post("/glo", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            getGloProduct(req.body.findterm).then(function (dataScrap) {
                res.status(200).json(dataScrap);
            });
        }
        catch (e) {
